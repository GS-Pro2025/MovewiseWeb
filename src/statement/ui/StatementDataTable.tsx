...
interface StatementDataTableProps {
  ...
  onEditRecord?: (record: StatementRecord) => void;
  onDeleteRecord?: (record: StatementRecord) => void;
}
        ...
        <table className="w-full">
          <thead className="sticky top-0 z-10 text-white" style={{ backgroundColor: '#0B2863' }}>
            <tr>
              ...
              <th className="px-4 py-3 text-center font-bold text-sm whitespace-nowrap" style={{ minWidth: 100 }}>
                {t('statementTable.actions', 'Actions')}
              </th>
            </tr>
          </thead>
                    ...
                    <td className="px-4 py-3 text-center" onClick={(e) => e.stopPropagation()}>
                      <div className="flex items-center justify-center gap-1">
                        <button
                          ...
                          title={t('statementTable.editTooltip', 'Edit')}
                        >
                          <svg className="w-4 h-4 transition-colors" style={{ color: '#0B2863' }}
                        ...
                        <button
                          ...
                          title={t('statementTable.deleteTooltip', 'Delete')}
                        >
                          <svg className="w-4 h-4 text-red-500 hover:text-red-700 transition-colors"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
