            ...
            {filteredOperators.length ? (
              filteredOperators.map((r, index) => (
                ...
                >
                  ...
                  <td className="py-2 px-4 font-bold text-gray-800 cursor-pointer">{r.code}</td>
              ...
              <tr>
                <td colSpan={weekdayKeys.length + 10} className="py-16 text-center">
                  <div className="flex flex-col items-center">
                    ...
                    <p className="text-gray-500 font-bold text-xl">
                      {searchTerm
                        ? t('payrollTable.noResultsSearch', { search: searchTerm })
                        : t('payrollTable.noData')}
                    </p>
                    <p className="text-gray-400 mt-2">{t('payrollTable.adjustCriteria')}</p>
                  </div>
                </td>
              </tr>
            )}
